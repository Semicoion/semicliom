...
public class Clothing_Category extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v= inflater.inflate(R.layout.fragment_clothing__category, container, false);
        return  v;
    }
    ...
    private void setViews() {
        mRecyclerView = requireView().findViewById(R.id.recyclerView3);
    ...
    private void setFirebase() {
        ...
        Query query = fStore.collection("Newbook").whereArrayContains("typeOfFragment",3);
            ...
            BookAdapter.setOnItemClickListener(new ItemAdabter.ClickListener() {
                ...
                public void onItemClick(int position, View v, List<item> BookItems) {
                    ...
                    if (BItem.getName() != null) {
                        ...
                        Toast.makeText(requireActivity(), "Doooonee", Toast.LENGTH_SHORT).show();
